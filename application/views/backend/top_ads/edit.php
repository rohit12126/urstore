  ...
  <div class="form-body"> 
    <div class="form-group">
      <div class="form-group">
        ...
        <div class="col-md-6"><?php echo date('d M Y,h:i  A',strtotime($row->updated_date)); ?></div>
      </div> 
    ...
    <div class="form-group">
      ...
      <div class="col-md-6">
        <select name="ad_type" id="ad_type" class="form-control ">
          ...
          <option value="1" <?php if ($$row->ad_type=='1') echo "selected" ;?> >Image</option>
          <option value="0" <?php if ($$row->ad_type=='0') echo "selected" ;?> >Script Code</option>
        </select>
      </div>
      ...
      <div class="col-lg-3">
          <div class="fileinput fileinput-new" data-provides="fileinput">
            <div class="fileinput-preview thumbnail" data-trigger="fileinput" >
              <img src="<?php  if ($row->thumb_image) { echo $row->thumb_image; } else{ echo base_url('/assets/front/images/graphic-default.png'); } ?>" data-src="holder.js/100%x100%" alt="...">
            </div>
          <div>
